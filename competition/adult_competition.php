...
<div class="wrap">
  ...
  <form method="POST" action="submit_adult.php" enctype="multipart/form-data">
      <input type="text" name="name" placeholder="Full Name" required value="<?=htmlspecialchars($user['customer_name'])?>">
      <input type="email" name="email" placeholder="Email" required value="<?=htmlspecialchars($user['customer_email'])?>">
