...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['pdf_file']['name'])) {
        $pdf_path = "uploads/pdf/" . time() . "_" . $_FILES['pdf_file']['name'];
    ...
    if (!empty($_FILES['cover_image']['name'])) {
        $cover_image = "uploads/covers/" . time() . "_" . $_FILES['cover_image']['name'];
        move_uploaded_file($_FILES['cover_image']['tmp_name'], $cover_image);
    }

    // Insert Query
    $insert = "INSERT INTO books (title, author, category, description, price, is_free, pdf_path, cover_image)
               VALUES ('$title', '$author', '$category', '$desc', '$price', '$is_free', '$pdf_path', '$cover_image')";
    ...
    <div class="card shadow p-4 mx-auto" style="max-width: 600px;">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="checkbox" name="is_free"> Yes this is free
            </div>
