...
if (isset($_POST['submit'])) {
    ...
    // Insert Query
    $insert = "INSERT INTO freebooks (title, author, category, description,  pdf_path, cover_image)
               VALUES ('$title', '$author', '$category', '$desc',  '$pdf_path', '$cover_image')";
...
// FETCH BOOKS
$result = mysqli_query($conn, "SELECT * FROM freebooks ");
if (!$result) {
        ...
        <div class="container">
            ...
            <header class="header p-4 mb-5 bg-white rounded">
                ...
                <button type="button" class="btn btn-custom btn-lg" data-bs-toggle="modal" data-bs-target="#addbooks">
                    <i class="bi bi-plus-lg"></i> Add Free Book
                </button>
