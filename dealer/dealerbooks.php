...
if (isset($_POST['submit'])) {
    ...
    // Insert Query
    $insert = "INSERT INTO dealer_books ( `dealer_id`, `title`, `author`, `category`, `description`, `price`, `pdf_path`, `cover_image`)
               VALUES ('$dealer_id','$title', '$author', '$category', '$desc', '$price',  '$pdf_path', '$cover_image')";
